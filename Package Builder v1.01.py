...
gui.theme('DarkAmber')
layout=[[gui.T("")],
        [gui.Text('choose a list of items: '),gui.Text(key='_file1_'),gui.FileBrowse(key='file1')],
        [gui.T('')],
        [gui.Text('choose a template: '),gui.Text(key="_file2_"),gui.FileBrowse(key="file2")],
        [gui.Text('packages built: '),gui.Text(key = 'pckg')],
        [gui.Button('Submit')]]
